...
export function DecisionAuditPanel({ agents }: { agents: Agent[] }) {
  ...
  return (
    <section className="min-h-0 overflow-hidden rounded-data border bg-white p-3 backdrop-blur">
      <div className="mb-3 flex items-start justify-between gap-3">
        ...
        <span className="rounded-badge border px-2 py-1 font-display text-[10px] text-[var(--text-muted)]">TIMELINE DAG</span>
      </div>
